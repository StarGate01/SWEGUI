...
\begin{document}
	\maketitle
	\pagestyle{plain}	%Disable page numbers
	\section{Overview}
...
The zero position of the map is shown as pointed cones in a cross shape. On the top left there is information about the currently displayed visualization ant on the bottom left there is a grid reference. In the top right corner you can see the color distribution across the displayed variables.

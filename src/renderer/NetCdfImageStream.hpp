    ...
    class NetCdfImageStream : public sf::InputStream
    {
        ...
        public:
            ...
            */
            ...
            /**
             * @brief Meta information about a data layer
            */
            struct Meta
            {
                int nx = 1,                             ///<Number of cells in x direction
                    ny = 1;                             ///<Number of cells in y direction
                float   min = -1.f,                     ///<Minimum value
                        max = 1.f;                      ///<Maximum value
                float   xmin = -1.f,                    ///<Minimum x coordinate
                        xmax = 1.f,                     ///<Maximum x coordinate
                        ymin = -0.5f,                   ///<Minimum y coordinate
                        ymax = 0.5f;                    ///<Maximum y coordinate
                int timestamps = 0;                     ///<Number of timestamps
            ...
            Meta meta_info;                                                 ///<Meta info of the last processed SWE netCDF layer
            ...
            */
            ...
            /**
             * @brief Gives the size of the stream
             * 
             * @return the size of the stream, -1 if failed
            */
            sf::Int64 getSize();
        ...
        private:
            ...
            void copy_le(int32_t value, char* target);                  ///<Copies a value a little endian into a buffer
